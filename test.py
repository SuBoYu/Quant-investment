...
mode = input("Please choose mode(single/all):")

if mode == "single":
    stocklist = []
    stock = input("Please input stockname:")
...
if mode == "all":
    #上市航運
    #url = "https://isin.twse.com.tw/isin/class_main.jsp?owncode=&stockname=&isincode=&market=1&issuetype=&industry_code=15&Page=1&chklike=Y"
